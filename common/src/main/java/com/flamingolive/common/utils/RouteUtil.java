...
public class RouteUtil {
    ...
    public static void forwardLauncher() {
        ...
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.apps.activity.LauncherActivity");
    ...
    public static void forwardLogin(Context context, String tip) {
        Intent intent = new Intent();
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.main.activity.LoginActivity");
    ...
    public static void forwardLoginInvalid(String tip) {
        Intent intent = new Intent();
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.main.activity.LoginInvalidActivity");
        intent.putExtra(Constants.TIP, tip);
    ...
    public static void teenagerTip(String tip) {
        Intent intent = new Intent();
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.main.activity.TeenagerTipActivity");
        intent.putExtra(Constants.TIP, tip);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        CommonAppContext.getInstance().startActivity(intent);
    }
    ...
    public static void forwardUserHome(Context context, String toUid, boolean fromLiveRoom, String fromLiveUid) {
        Intent intent = new Intent();
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.main.activity.UserHomeActivity");
    ...
    public static void forwardMyCoin(Context context) {
        Intent intent = new Intent();
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.main.activity.MyCoinActivity");
        context.startActivity(intent);
    }
    ...
    public static void forwardGoodsDetail(final Context context, final String goodsId, final boolean fromShop, final String liveUid, final String shareUid, final Parcelable liveBean) {
        ...
        CommonHttpUtil.checkGoodsExist(goodsId, new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0) {
                    Intent intent = new Intent();
                    intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.mall.activity.GoodsDetailActivity");
    ...
    public static void forwardGoodsDetailOutSide(final Context context, final String goodsId, final boolean fromShop, final Parcelable liveBean) {
        ...
        CommonHttpUtil.checkGoodsExist(goodsId, new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0) {
                    Intent intent = new Intent();
                    intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.mall.activity.GoodsOutSideDetailActivity");
                    intent.putExtra(Constants.MALL_GOODS_ID, goodsId);
    ...
    public static void forwardPayContentDetail(Context context, String goodsId) {
        ...
        Intent intent = new Intent();
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.mall.activity.PayContentDetailActivity");
        intent.putExtra(Constants.MALL_GOODS_ID, goodsId);
        context.startActivity(intent);
    }
    ...
    public static void forwardVideoPlay(Context context, String videoUrl, String coverImgUrl) {
        Intent intent = new Intent();
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.main.activity.ActiveVideoPlayActivity");
    ...
    public static void forwardAuth(AbsActivity activity, int requestCode) {
        Intent intent = new Intent();
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.main.activity.AuthActivity");
    ...
    public static void forwardActivePub(Context context, String goodsId) {
        Intent intent = new Intent();
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.main.activity.ActivePubActivity");
        intent.putExtra(Constants.MALL_GOODS_ID, goodsId);
        context.startActivity(intent);
    }
    ...
    public static void forwardShareGoods(Context context, String goodsId) {
        Intent intent = new Intent();
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.main.activity.GoodsShareFriendActivity");
        intent.putExtra(Constants.MALL_GOODS_ID, goodsId);
        context.startActivity(intent);
    }
    ...
    public static void forwardTeenager(Context context) {
        Intent intent = new Intent();
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.main.activity.TeenagerActivity");
        context.startActivity(intent);
    }

    public static void forwardLiveAudienceActivity(Context context) {
        Intent intent = new Intent();
        intent.setClassName(CommonAppConfig.PACKAGE_NAME, "com.flamingolive.live.activity.LiveAudienceActivity");
        context.startActivity(intent);
    }
