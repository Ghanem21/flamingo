package com.flamingolive.common;
...
import com.flamingolive.common.utils.DeviceUtils;
...
public class CommonAppConfig {
    public static final String PACKAGE_NAME = "com.flamingolive.apps";
    //Http请求头 Header
    ...
    private static String getExternalPath() {
        String outPath = null;
        try {
            File externalFilesDir = CommonAppContext.getInstance().getExternalFilesDir("flamingolive");
    ...
    public static boolean isYunBaoApp() {
        if (!TextUtils.isEmpty(PACKAGE_NAME)) {
            return PACKAGE_NAME.contains("com.flamingolive.apps");
        }
        return false;
    }
    ...
    public String getAppName() {
        if (TextUtils.isEmpty(mAppName)) {
            int res = CommonAppContext.getInstance().getResources().getIdentifier("app_name", "string", "com.flamingolive.apps");
    ...
    public int getAppIconRes() {
        if (mAppIconRes == 0) {
            mAppIconRes = CommonAppContext.getInstance().getResources().getIdentifier("icon_app", "mipmap", "com.flamingolive.apps");
        }
        return mAppIconRes;
    }
