...
public class FamilyApplyActivity extends AbsActivity implements View.OnClickListener {
    ...
    private ImageResultCallback mImageResultCallback = new ImageResultCallback() {
        ...
        public void onSuccess(File file) {
            if (file != null && file.exists()) {
                ...
                ToastUtil.show(com.flamingolive.mall.R.string.file_not_exist);
            }
        }
    ...
    private void chooseImage() {
        DialogUitl.showStringArrayDialog(mContext, new Integer[]{com.flamingolive.mall.R.string.alumb, com.flamingolive.mall.R.string.camera}, new DialogUitl.StringArrayDialogCallback() {
            @Override
            public void onItemClick(String text, int tag) {
                if (tag == com.flamingolive.mall.R.string.camera) {
                    MediaUtil.getImageByCamera(FamilyApplyActivity.this, false, mImageResultCallback);
                } else if (tag == com.flamingolive.mall.R.string.alumb) {
